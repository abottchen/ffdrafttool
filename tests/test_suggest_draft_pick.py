...
class TestSuggestDraftPick:
    ...
    async def test_suggest_basic_functionality(
        ...
        with patch(
            ...
            result = await suggest_draft_pick(sample_draft_state, team_name="Test Team")
    ...
    async def test_strategy_balanced(
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", strategy="balanced"
            )
    ...
    async def test_strategy_best_available(
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", strategy="best_available"
            )
    ...
    async def test_strategy_upside(self, sample_draft_state, sample_analysis_response):
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", strategy="upside"
            )
    ...
    async def test_strategy_safe(self, sample_draft_state, sample_analysis_response):
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", strategy="safe"
            )
    ...
    async def test_bye_week_consideration(
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", consider_bye_weeks=True
            )
            ...
            result_no_bye = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team", consider_bye_weeks=False
            )
    ...
    async def test_round_specific_guidance(
        ...
        with patch(
            ...
            result = await suggest_draft_pick(
                sample_draft_state, team_name="Test Team"
            )  # Round 2 = auction
            ...
            result_snake = await suggest_draft_pick(
                snake_draft_state, team_name="Test Team"
            )
    ...
    async def test_invalid_strategy(self, sample_draft_state):
        ...
        result = await suggest_draft_pick(
            sample_draft_state, team_name="Test Team", strategy="invalid_strategy"
        )
